    ...
    constructor() {
            ...
            try {
                ...
                if (orders) {
                    let o = yield Promise.all(orders.map((or) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (detail) {
                            return Object.assign(Object.assign(Object.assign({}, or), { status: detail['isSuspended'] ? 'suspended' : detail['isStarted'] ? 'started' : 'assigned' }), !detail['isSuspended'] && { progressId: detail['_id'] });
                        }
                        else {
                            return Object.assign(Object.assign({}, or), { status: 'not_assigned' });
                        }
                    })));
        ...
        this.uploadAssignment = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                awsResponse = yield this.awsS3Service.uploadFile(req["files"]["fileLink"], `${token}`, "StudentAssignments");
