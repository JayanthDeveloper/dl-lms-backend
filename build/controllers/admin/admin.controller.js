...
class AdminController {
    constructor() {
        ...
        this.createInstructor = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (emailMatched) {
                    ...
                    const hashedPassword = yield bcryptjs_1.hash(req.body.password, 10);
                    const requestBody = Object.assign(Object.assign({}, req.body), { password: hashedPassword, lastLoggedIn: moment_1.default().unix() });
            ...
            try {
                ...
                if (courses) {
                    let data = yield Promise.all(courses[0].map((c) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        return Object.assign(Object.assign({}, c), { studentsCount: count });
                    })));
                    res.status(200).json({
                        data,
                        total: courses[1]
        ...
        this.updateCourseBatch = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                let request = Object.assign(Object.assign({}, req.body), (req.body["projects"] && {
                    projects: req.body["projects"].map((p) => (Object.assign(Object.assign({}, (!p["id"] && { id: uuid_1.default() })), p))),
                }));
            ...
            try {
                ...
                if (emailMatched) {
                    ...
                    if (phoneMatched) {
                        ...
                        const hashedPassword = yield bcryptjs_1.hash(req.body.password, 10);
                        const requestBody = Object.assign(Object.assign({}, req.body), { password: hashedPassword, lastLoggedIn: moment_1.default().unix(), lastUpdatedAt: Date.now() });
        ...
        this.editUser = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const updated = yield student_model_1.default.findByIdAndUpdate(req.body.userId, {
                    $set: Object.assign(Object.assign({}, request), { lastUpdatedAt: Date.now() }),
                });
                if (updated) {
                    res.status(200).json("done");
                }
        ...
        this.createBatch = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (checkCourse) {
                    ...
                    const batch = yield course_batch_model_1.default.create(Object.assign(Object.assign({}, req.body), { id: `${req.body["courseName"].substring(0, 3)}${id}`, curriculum: checkCourse["curriculum"] }));
                    if (batch) {
